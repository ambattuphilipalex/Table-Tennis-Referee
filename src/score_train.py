...
EVAL_GAME_ID = "3"
VAL_CHECK_EVERY = 5  # epochs
MAX_CLASS_WEIGHT = 75.0
...
def train():
    ...
    class_weights = torch.tensor([1.0, w1 * 2.0, w2 * 2.0]).to(device)
    ...
    print(f"Inferred input_dim={inferred_input_dim} from dataset "
          f"(feature_dim={dataset_list[0].feature_dim} + 3 coord dims)")
    ...
    print("\nStarting training with feature fusion...")
    best_f1 = -1.0
